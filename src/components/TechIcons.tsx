...
// Use standard <img> for icons to support non-Next.js environments
const Img = ({ src, alt }: { src: string; alt: string }) => (
  <img src={src} alt={alt} width={40} height={40} style={{ objectFit: 'contain' }} />
);
...
export const PostgreSQLIcon = () => (
  <Img src="/icons/PostgresSQL.png" alt="PostgreSQL" />
);
...
export const TailwindIcon = () => (
  <Img src="/icons/Tailwind CSS.png" alt="Tailwind CSS" />
);
...
export const HibernateIcon = () => (
  <Img src="/icons/Hibernate.png" alt="Hibernate" />
);
